...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void setLocation([List<String>? locationList]) async {
    ...
    if (locationList == null) {
      ...
      currentLocation = await location.getLocationFromAddress(
          locationList[0], locationList[1], locationList[2]) as location.Location;
    }
...
class LocationTabWidget extends StatelessWidget {
  const LocationTabWidget({super.key, required this.setLocation});
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(border: OutlineInputBorder(), labelText: "State"),
            ),
            SizedBox(height: 8),
            TextField(
              controller: zipController,
              decoration: InputDecoration(border: OutlineInputBorder(), labelText: "Zip"),
            ),
            SizedBox(height: 16),
            ElevatedButton(
              onPressed: () {
          ...
          children: [
            ...
            _dailyForecasts.isNotEmpty
                ? ForecastSummariesWidget(
                    forecasts: _dailyForecasts, setActiveForecast: _setActiveForecast)
                : Text(""),
