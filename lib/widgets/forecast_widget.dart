...
import 'package:weatherapp/widgets/forecast_summary_widget.dart' as forecast_summary_icon;
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            forecast_summary_icon.WeatherIconWidget(iconPath: _forecast.getIconPath(), height: 100.0, width: 100.0),
          ],
        ),
      ),
    );
